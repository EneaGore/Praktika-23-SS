...
<p> By saying ingredient and the name of the ingridient you can add it like :"ingredient gin"</p> 
<p> Remove an ingredient by saying remove ingredient like so : "remove gin" </p> 
 </div> 
			<a onclick ="say_something('Hello world, un kam j an anisen')"> listen </a>
			<a onclick ="open_gpt3()"> GPT-3 bartender </a>
			<a onclick= "make_black()"> DARK MODE   </a>  
<a onclick="request_notifs()"> Enable Notifications </a>
		</div>
...
// XXX Browser detection
//
var isChrome = !!window.chrome;
var isFire = navigator.userAgent.search("Firefox");
if(isChrome){
	//alert("For best user experience switch to Firefox, unless you want to use the handless version in which case chrome is right for you")
}
if(isFire >-1){
...
// XXX Bzukd the ingredient lists with plus minus thing
...
// get the variables from the link just like we do in php

// XXX Read the url variables
let sum = 0
...
function do_drink(){
	...
	const test_url = "https://lehre.bpm.in.tum.de/~ge72git/async/server/order_queue.php"
